#[Noroeste, Norte, Nordeste] =  [(x-1;y+1), (x;y+1), (x+1;y+1)]  =  [0,1,2]
#[Oeste ,  Centro  , Leste]  =  [(x-1;y)  , (x;y)  , (x+1;y)  ]  =  [3,x,4]
#[Sudoeste , Sul , Sudeste]  =  [(x-1;y-1), (x;y-1), (x+1;y-1)]  =  [5,6,7]
#
...
def calc_distancia(atualX, atualY, destinoX, destinoY):
  ...
  listDistancias[0] = [noroeste, atualX-1, atualY+1]
  listDistancias[1] = [norte, atualX, atualY+1]
  listDistancias[2] = [nordeste, atualX+1, atualY+1]
  listDistancias[3] = [oeste, atualX-1, atualY]
  listDistancias[4] = [leste, atualX+1, atualY]
  listDistancias[5] = [sudoeste, atualX-1, atualY-1]
  listDistancias[6] = [sul, atualX, atualY-1]
  listDistancias[7] = [sudeste, atualX+1, atualY-1]

  print(listDistancias)
